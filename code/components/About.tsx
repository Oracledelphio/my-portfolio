...
export default function About() {
  ...
  const handleTerminalSubmit = (e) => {
    ...
    if (command === "ls") {
      ...
      newOutput.push({
        type: "error",
        text: `Command not found: ${command}. Try "ls"`,
      });
    }
  ...
  return (
    <section
      id="about"
      className="relative py-32 px-6 lg:px-12 overflow-hidden bg-[#F6EFE8]"
    >
      <div className="max-w-[1400px] mx-auto relative z-10">
        ...
        >
          <h2
            className="text-5xl lg:text-7xl font-black text-[#5A4036] mb-6"
            style={{ fontFamily: "'Playfair Display', serif" }}
          >
            ABOUT ME
          </h2>
          <div className="w-78 h-2 bg-[#F2A6A6] rounded-full" />
        </div>
          ...
          >
            <div className="space-y-6">
              <p className="text-2xl lg:text-3xl text-[#5A4036] leading-relaxed font-light">
                ...
                <span className="font-bold text-[#F2A6A6]">
                  full-stack development
                </span>
                ,{" "}
                <span className="font-bold text-[#F2A6A6]">deep learning</span>
                {""}.
              </p>

              <p className="text-lg text-[#9E948C] leading-relaxed">
                Passionate about crafting seamless, user-friendly interfaces
                powered by AI-driven intelligence. Dedicated to building
                scalable web solutions that blend technical depth with
                meaningful, impactful user experiences.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 pt-8">
              <div className="border-l-4 border-[#F2A6A6] pl-6 py-4">
                <div className="text-3xl font-black text-[#5A4036] mb-2">
                  CVIP 2025
                </div>
                <div className="text-sm text-[#9E948C] uppercase tracking-wider">
                  Published Paper
                </div>
              </div>
